...
| 23/06/2026 | Fogli Selezionati con colonne fisse + formattazione leggibile + ordinati per Score (AZIONI 30 col, ETF 20 col, FONDI US 16 col); verifica `_build_client_attachment` — corretto per tutti e 4 gli screener |
| 23/06/2026 | Tab Servizi dashboard: campo "Profilo target" → textarea multiriga (12rem); `servizi_config.json` aggiornato con profili investitore completi per tutti e 9 i servizi |
